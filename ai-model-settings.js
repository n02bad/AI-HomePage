(function () {
  ...
  const AI_MODEL_PRESETS = {
    ...
    minimax: {
      ...
      model: "MiniMax-M3",
      models: ["MiniMax-M3", "MiniMax-M3-highspeed", "MiniMax-M2.7", "MiniMax-M2.7-highspeed", "MiniMax-M2.5", "MiniMax-M2.5-highspeed", "MiniMax-M2.1"],
    ...
    kimi: {
      ...
      badge: "OpenAI Compatible",
      model: "kimi-k3",
      models: ["kimi-k3", "kimi-k3-thinking", "kimi-k2.6", "kimi-k2.5", "kimi-k2-thinking", "moonshot-v1-128k"],
    ...
    gemini: {
      ...
      note: `Google Gemini API 的 OpenAI 兼容接口；可选择 Gemini 2.5、Gemini 3 Flash Preview、Gemini 3.1 Flash / Flash-Lite 和 Gemini 3.1 Pro（含正式版与 Preview）文本模型。Base URL 是 ${GEMINI_OPENAI_BASE_URL}。`,
    },
  };
